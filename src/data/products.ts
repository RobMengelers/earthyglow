...
const img = (file: string, width = 900) =>
  `https://earthyglow.nl/cdn/shop/files/${file}?width=${width}`
    ...
    products: [
      {
        ...
        href: 'https://earthyglow.nl/products/the-floral-box',
      ...
      },
      {
        ...
        href: 'https://earthyglow.nl/products/the-floral-basket',
        collectionId: 'little-glow',
        description:
    ...
    products: [
      {
        ...
        href: 'https://earthyglow.nl/products/coconut-beach',
      ...
      },
      {
        ...
        href: 'https://earthyglow.nl/products/autumn-ember',
        collectionId: 'scented-glow',
        description:
      ...
      },
      {
        ...
        href: 'https://earthyglow.nl/products/pumpkin-spice',
        collectionId: 'scented-glow',
        soldOut: true,
        description:
      ...
      },
      {
        ...
        href: 'https://earthyglow.nl/products/pumpkin-spice-latte',
        collectionId: 'scented-glow',
        description:
    ...
    products: [
      {
        ...
        href: 'https://earthyglow.nl/products/column-candle',
      ...
      },
      {
        ...
        href: 'https://earthyglow.nl/products/pillar-candle',
        collectionId: 'natural-glow',
        description:
      ...
      },
      {
        ...
        href: 'https://earthyglow.nl/products/spiral-candle',
        collectionId: 'natural-glow',
        description:
      ...
      },
      {
        ...
        href: 'https://earthyglow.nl/products/shell-candle',
        collectionId: 'natural-glow',
        description:
      ...
      },
      {
        ...
        href: 'https://earthyglow.nl/products/arch',
        collectionId: 'natural-glow',
        description:
      ...
      },
      {
        ...
        href: 'https://earthyglow.nl/products/the-shape-bubble-l',
        collectionId: 'natural-glow',
        description:
...
export const heroImage = img('17ba3741-6495-4fc7-84fe-a4653dbdda61.png', 1400)
export const aboutImage = img('Schermafbeelding_2026-05-30_164759.png', 1200)